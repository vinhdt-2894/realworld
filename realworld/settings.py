...
SECRET_KEY = "django-insecure-&g0s11&ax*g33b1#8*6!lo*3wuaud(4minex$k70zdf__m51%d"
...
AUTHENTICATION_BACKENDS = [
    "api.users.backends.EmailBackend",
...
SPECTACULAR_SETTINGS = {
    "TAGS": [
        ...
        {"name": "Articles", "description": "Article CRUD and actions"},
